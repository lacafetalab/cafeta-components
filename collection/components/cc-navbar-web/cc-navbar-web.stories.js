...
const navbarWebBuilder = (itemsWrapper, values) => {
  const profilemenu = document.createElement("cc-navbar-web");
...
export const NavbarWeb = () => {
  ...
  const dropdown11 = navbarWebBuilder(itemsWrapper, {
  ...
  const dropdown12 = navbarWebBuilder(itemsWrapper, {
    placeholder: defaultValue1,
    disabled: value2,
    error: value3,
    label: value4,
  ...
  const dropdown21 = navbarWebBuilder(itemsWrapper, {
    placeholder: defaultValue1,
    disabled: value2,
    error: value3,
    label: value4,
  ...
  const dropdown22 = navbarWebBuilder(itemsWrapper, {
    placeholder: defaultValue1,
    disabled: value2,
    error: value3,
    label: value4,
  ...
  const dropdown31 = navbarWebBuilder(itemsWrapper, {
    placeholder: defaultValue1,
    disabled: value2,
    error: value3,
    label: value4,
  ...
  const dropdown32 = navbarWebBuilder(itemsWrapper, {
    placeholder: defaultValue1,
    disabled: value2,
    error: value3,
    border: false,
  ...
  <div class="p-lg">
    ...
    <section class="py-xlg  ">
      ...
      <h2 class="text-subheading-02 mb-lg font-regular font-black mt-xlg inline-block">ProfileMenu Secondary</h1>
      <div class="flex items-end mb-lg">
      ...
      <h2 class="text-subheading-02 mb-lg font-regular font-black mt-xlg inline-block">ProfileMenu No Border</h1>
      <div class="flex items-end mb-lg">
