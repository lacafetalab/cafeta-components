...
var CcCheckfield = /** @class */ (function () {
    ...
    CcCheckfield.prototype.render = function () {
        return (h(Host, { "data-testid": "cc-checkfield", class: "CheckField" }, h("label", { class: "checkfield__wrapper" }, h("div", { class: {
            ...
            } }), this.shape === "square" && (h("cc-icon", { name: "check", class: "checkfield__check", size: this.size === "medium" ? 12 : 10 }))), this.label && (h("span", { class: {
