...
// [ '00', '01', '02', ..., 'fe', 'ff' ]
var HEX_NUMBERS = new Array(256).fill()
    .map(function (val, index) { return ('0' + (index).toString(16)).slice(-2); });
/**
 ...
 * @extends Error
 */
var CKEditorError = /** @class */ (function (_super) {
    __extends(CKEditorError, _super);
    /**
    ...
    function CKEditorError(errorName, context, data) {
        var _this = this;
        var message = "" + errorName + (data ? " " + JSON.stringify(data) : '') + getLinkToDocumentationMessage(errorName);
     ...
     */
    CKEditorError.prototype.is = function (type) {
     ...
     */
    CKEditorError.rethrowUnexpectedError = function (err, context) {
...
var EmitterMixin = {
    ...
    once: function (event, callback, options) {
        ...
        var onceCallback = function (event) {
            ...
            if (!wasFired) {
                ...
                callback.call.apply(callback, __spreadArrays([this, event], args));
            }
        };
     ...
     * @inheritDoc
     */
    listenTo: function (emitter, event, callback, options) {
        if (options === void 0) { options = {}; }
        var emitterInfo, eventCallbacks;
    ...
    fire: function (eventOrInfo) {
        ...
        try {
            ...
            if (callbacks) {
                ...
                var callbackArgs = __spreadArrays([eventInfo], args);
    ...
    delegate: function () {
        ...
        return {
            to: function (emitter, nameOrFunction) {
     ...
     * @inheritDoc
     */
    stopDelegating: function (event, emitter) {
        if (!this._delegations) {
            return;
        }
        if (!event) {
...
function createEventNamespace(source, eventName) {
    ...
    if (name !== '') {
        ...
        for (var _i = 0, newEventNodes_1 = newEventNodes; _i < newEventNodes_1.length; _i++) {
            var node = newEventNodes_1[_i];
...
function fireDelegatedEvents(destinations, eventInfo, fireArgs) {
    for (var _i = 0, destinations_1 = destinations; _i < destinations_1.length; _i++) {
        var _a = destinations_1[_i], emitter = _a[0], name = _a[1];
        if (!name) {
            name = eventInfo.name;
        }
        ...
        delegatedInfo.path = __spreadArrays(eventInfo.path);
        emitter.fire.apply(emitter, __spreadArrays([delegatedInfo], fireArgs));
    }
}
...
/** Built-in value references. */
var Buffer$1 = moduleExports$2 ? root.Buffer : undefined, allocUnsafe = Buffer$1 ? Buffer$1.allocUnsafe : undefined;
/**
...
var dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map$1), promiseCtorString = toSource(Promise), setCtorString = toSource(Set$1), weakMapCtorString = toSource(WeakMap$1);
/**
...
var ObservableMixin = {
    ...
    bind: function () {
        ...
        var bindProperties = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            bindProperties[_i] = arguments[_i];
        }
        ...
        bindProperties.forEach(function (propertyName) {
            if (boundProperties.has(propertyName)) {
                 ...
                 */
                throw new CKEditorError('observable-bind-rebind', _this);
            }
        });
    ...
    unbind: function () {
        var _this = this;
        var unbindProperties = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            unbindProperties[_i] = arguments[_i];
        }
        ...
        if (unbindProperties.length) {
            ...
            unbindProperties.forEach(function (propertyName) {
                ...
                binding.to.forEach(function (to) {
                    ...
                    if (!Object.keys(toProperties).length) {
                        ...
                        _this.stopListening(toObservable, 'change');
                    }
                });
            ...
            boundObservables.forEach(function (bindings, boundObservable) {
                _this.stopListening(boundObservable, 'change');
            });
    ...
    decorate: function (methodName) {
        ...
        if (!originalMethod) {
             ...
             */
            throw new CKEditorError('observablemixin-cannot-decorate-undefined', this, { object: this, methodName: methodName });
        }
        this.on(methodName, function (evt, args) {
            evt.return = originalMethod.apply(_this, args);
        });
...
function bindTo() {
    ...
    var parsedArgs = parseBindToArgs.apply(void 0, args);
    ...
    parsedArgs.to.forEach(function (to) {
        ...
        if (to.properties.length && to.properties.length !== numberOfBindings) {
             ...
             */
            throw new CKEditorError('observable-bind-to-properties-length', _this);
        }
        // When no to.properties specified, observing source properties instead i.e.
        // A.bind( 'x', 'y' ).to( B ) -> Observe B.x and B.y
        if (!to.properties.length) {
            to.properties = _this._bindProperties;
        }
    });
    ...
    this._bindProperties.forEach(function (propertyName) {
        updateBoundObservableProperty(_this._observable, propertyName);
    });
}
...
function bindToMany(observables, attribute, callback) {
    ...
    this.to.apply(this, __spreadArrays(getBindingTargets(observables, attribute), [
...
function getBindingTargets(observables, attribute) {
    var observableAndAttributePairs = observables.map(function (observable) { return [observable, attribute]; });
...
function isStringArray(arr) {
    return arr.every(function (a) { return typeof a == 'string'; });
}
...
function updateBoundObservableProperty(observable, propertyName) {
    ...
    if (binding.callback) {
        propertyValue = binding.callback.apply(observable, binding.to.map(function (to) { return to[0][to[1]]; }));
    }
    else {
...
var Plugin = /** @class */ (function () {
     ...
     */
    Plugin.prototype.forceDisabled = function (id) {
     ...
     */
    Plugin.prototype.clearForceDisabled = function (id) {
    ...
    Object.defineProperty(Plugin, "isContextPlugin", {
        /**
         * @inheritDoc
         */
        get: function () {
...
function isWindow(obj) {
    var stringifiedObject = Object.prototype.toString.apply(obj);
...
var DomEmitterMixin = assignIn({}, EmitterMixin, {
    ...
    listenTo: function (emitter) {
        ...
        (_a = EmitterMixin.listenTo).call.apply(_a, __spreadArrays([this, emitter], rest));
    },
    /**
     * Stops listening for events. It can be used at different levels:
     * It is backwards compatible with {@link module:utils/emittermixin~EmitterMixin#listenTo}.
     ...
     */
    _getProxyEmitter: function (node) {
 ...
 * @private
 */
var ProxyEmitter = /** @class */ (function () {
    /**
...
assignIn(ProxyEmitter.prototype, EmitterMixin, {
     ...
     * and prevents blocking browser's main thread by this event handler.
     */
    attach: function (event, callback, options) {
        if (options === void 0) { options = {}; }
        ...
        var domListener = this._createDomListener(event, listenerOptions);
     ...
     */
    _createDomListener: function (event, options) {
        var _this = this;
        var domListener = function (domEvt) {
        ...
        domListener.removeListener = function () {
            _this._domNode.removeEventListener(event, domListener, options);
...
var Observer = /** @class */ (function () {
     ...
     */
    Observer.prototype.checkShouldIgnoreEventFromTarget = function (domTarget) {
 ...
 */
var ImageLoadObserver = /** @class */ (function (_super) {
    __extends(ImageLoadObserver, _super);
     ...
     * @inheritDoc
     */
    ImageLoadObserver.prototype.observe = function (domRoot) {
        var _this = this;
     ...
     */
    ImageLoadObserver.prototype._fireEvents = function (domEvent) {
        if (this.isEnabled) {
 ...
 */
var HighlightStack = /** @class */ (function () {
    /**
     ...
     */
    HighlightStack.prototype.add = function (descriptor, writer) {
     ...
     * @param {module:engine/view/downcastwriter~DowncastWriter} writer
     */
    HighlightStack.prototype.remove = function (id, writer) {
        var stack = this._stack;
        var oldTop = stack[0];
     ...
     * @param {module:engine/conversion/downcasthelpers~HighlightDescriptor} descriptor
     */
    HighlightStack.prototype._insertDescriptor = function (descriptor) {
        var stack = this._stack;
        var index = stack.findIndex(function (item) { return item.id === descriptor.id; });
     ...
     */
    HighlightStack.prototype._removeDescriptor = function (id) {
        var stack = this._stack;
        var index = stack.findIndex(function (item) { return item.id === id; });
...
var Collection = /** @class */ (function () {
     ...
     */
    function Collection(initialItemsOrOptions, options) {
        if (initialItemsOrOptions === void 0) { initialItemsOrOptions = {}; }
        if (options === void 0) { options = {}; }
        ...
        if (hasInitialItems) {
            for (var _i = 0, initialItemsOrOptions_1 = initialItemsOrOptions; _i < initialItemsOrOptions_1.length; _i++) {
                var item = initialItemsOrOptions_1[_i];
     ...
     * @fires change
     */
    Collection.prototype.addMany = function (items, index) {
        if (index === undefined) {
     ...
     */
    Collection.prototype.get = function (idOrIndex) {
        var item;
     ...
     */
    Collection.prototype.has = function (itemOrId) {
     ...
     */
    Collection.prototype.getIndex = function (itemOrId) {
        var item;
        if (typeof itemOrId == 'string') {
     ...
     * @fires change
     */
    Collection.prototype.remove = function (subject) {
        var _a = this._remove(subject), item = _a[0], index = _a[1];
        this.fire('change', {
            added: [],
            removed: [item],
            index: index
     ...
     */
    Collection.prototype.map = function (callback, ctx) {
     ...
     */
    Collection.prototype.find = function (callback, ctx) {
     ...
     */
    Collection.prototype.filter = function (callback, ctx) {
     ...
     */
    Collection.prototype.bindTo = function (externalCollection) {
        var _this = this;
        if (this._bindToCollection) {
            /**
        ...
        return {
            as: function (Class) {
                _this._setUpBindToBinding(function (item) { return new Class(item); });
            },
            using: function (callbackOrProperty) {
                if (typeof callbackOrProperty == 'function') {
                    _this._setUpBindToBinding(function (item) { return callbackOrProperty(item); });
                }
                else {
                    _this._setUpBindToBinding(function (item) { return item[callbackOrProperty]; });
                }
            }
        };
    };
     ...
     */
    Collection.prototype._setUpBindToBinding = function (factory) {
        var _this = this;
        var externalCollection = this._bindToCollection;
        // Adds the item to the collection once a change has been done to the external collection.
        //
        // @private
        var addItem = function (evt, externalItem, index) {
            var isExternalBoundToThis = externalCollection._bindToCollection == _this;
            ...
            if (isExternalBoundToThis && externalItemBound) {
                _this._bindToExternalToInternalMap.set(externalItem, externalItemBound);
                _this._bindToInternalToExternalMap.set(externalItemBound, externalItem);
            }
            else {
                var item = factory(externalItem);
                // When there is no item we need to remember skipped index first and then we can skip this item.
                if (!item) {
                    _this._skippedIndexesFromExternal.push(index);
                    return;
                }
                ...
                // internal -> [ 'A', 'D' ]
                for (var _i = 0, _a = _this._skippedIndexesFromExternal; _i < _a.length; _i++) {
                    var skipped = _a[_i];
                    if (index > skipped) {
                        finalIndex--;
                    }
                ...
                for (var _b = 0, _c = externalCollection._skippedIndexesFromExternal; _b < _c.length; _b++) {
                    var skipped = _c[_b];
                    if (finalIndex >= skipped) {
                        finalIndex++;
                    }
                }
                _this._bindToExternalToInternalMap.set(externalItem, item);
                _this._bindToInternalToExternalMap.set(item, externalItem);
                _this.add(item, finalIndex);
        ...
        for (var _i = 0, externalCollection_1 = externalCollection; _i < externalCollection_1.length; _i++) {
            var externalItem = externalCollection_1[_i];
        ...
        this.listenTo(externalCollection, 'remove', function (evt, externalItem, index) {
            var item = _this._bindToExternalToInternalMap.get(externalItem);
            if (item) {
                _this.remove(item);
            }
            // After removing element from external collection we need update/remove indexes
            // of skipped items in internal collection.
            _this._skippedIndexesFromExternal = _this._skippedIndexesFromExternal.reduce(function (result, skipped) {
                if (index < skipped) {
     ...
     * @returns {String}
     */
    Collection.prototype._getItemIdBeforeAdding = function (item) {
        var idProperty = this._idProperty;
        var itemId;
     ...
     * @fires remove
     */
    Collection.prototype._remove = function (subject) {
        var index, id, item;
 ...
 * @mixes module:utils/observablemixin~ObservableMixin
 */
var ViewCollection = /** @class */ (function (_super) {
     ...
     */
    function ViewCollection(initialItems) {
        if (initialItems === void 0) { initialItems = []; }
        var _this = _super.call(this, initialItems, {
    ...
    ViewCollection.prototype.destroy = function () {
        this.map(function (view) { return view.destroy(); });
    };
    /**
     ...
     */
    ViewCollection.prototype.setParent = function (elementOrDocFragment) {
     ...
     */
    ViewCollection.prototype.delegate = function () {
        var _this = this;
        var events = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            events[_i] = arguments[_i];
            ...
            to: function (dest) {
                ...
                for (var _i = 0, _a = _this; _i < _a.length; _i++) {
                    ...
                    for (var _b = 0, events_1 = events; _b < events_1.length; _b++) {
                        var evtName = events_1[_b];
                        view.delegate(evtName).to(dest);
                    }
                }
                // Activate delegating on future views in this collection.
                _this.on('add', function (evt, view) {
                    for (var _i = 0, events_2 = events; _i < events_2.length; _i++) {
                        var evtName = events_2[_i];
                        view.delegate(evtName).to(dest);
                    }
                });
     ...
     */
    ViewCollection.prototype._renderViewIntoCollectionParent = function (view, index) {
        if (!view.isRendered) {
            view.render();
        }
...
var Template = /** @class */ (function () {
     ...
     */
    Template.prototype.apply = function (node) {
     ...
     */
    Template.prototype.revert = function (node) {
        if (!this._revertData) {
            /**
     ...
     */
    Template.prototype.getViews = function () {
        function search(def) {
            var _i, _a, child;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!def.children) return [3 /*break*/, 6];
                        _i = 0, _a = def.children;
                        _b.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 6];
                        child = _a[_i];
                        if (!isView(child)) return [3 /*break*/, 3];
                        return [4 /*yield*/, child];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
                        if (!isTemplate(child)) return [3 /*break*/, 5];
                        return [5 /*yield**/, __values(search(child))];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [5 /*yield**/, __values(search(this))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
     ...
     */
    Template.bind = function (observable, emitter) {
        return {
            to: function (eventNameOrFunctionOrAttribute, callback) {
            ...
            if: function (attribute, valueIfTrue, callback) {
     ...
     */
    Template.extend = function (template, def) {
     ...
     */
    Template.prototype._renderNode = function (data) {
        var isInvalid;
        if (data.node) {
     ...
     * @param {module:ui/template~RenderData} data Rendering data.
     */
    Template.prototype._renderElement = function (data) {
        var node = data.node;
        if (!node) {
     ...
     * @param {module:ui/template~RenderData} data Rendering data.
     */
    Template.prototype._renderText = function (data) {
        var node = data.node;
     ...
     * @param {module:ui/template~RenderData} data Rendering data.
     */
    Template.prototype._renderAttributes = function (data) {
        ...
        for (attrName in this.attributes) {
            ...
            //
                ...
                attrValue = attrValue
                    ...
                    //		]
                    //
                    .map(function (val) { return val ? (val.value || val) : val; })
                    // Flatten the array.
     ...
     * @param {module:ui/template~RenderData} data Rendering data.
     */
    Template.prototype._renderStyleAttribute = function (styles, data) {
        var node = data.node;
     ...
     * @param {module:ui/template~RenderData} data Rendering data.
     */
    Template.prototype._renderElementChildren = function (data) {
        var node = data.node;
     ...
     * @param {module:ui/template~RenderData} data Rendering data.
     */
    Template.prototype._setUpListeners = function (data) {
        if (!this.eventListeners) {
            return;
        }
        var _loop_1 = function (key) {
            var revertBindings = this_1.eventListeners[key].map(function (schemaItem) {
                var _a = key.split('@'), domEvtName = _a[0], domSelector = _a[1];
     ...
     */
    Template.prototype._bindToObservable = function (_a) {
        var schema = _a.schema, updater = _a.updater, data = _a.data;
        var revertData = data.revertData;
        // Set initial values.
        syncValueSchemaValue(schema, updater, data);
        var revertBindings = schema
            // Filter "falsy" (false, undefined, null, '') value schema components out.
            .filter(function (item) { return !isFalsy(item); })
            // Filter inactive bindings from schema, like static strings ('foo'), numbers (42), etc.
            .filter(function (item) { return item.observable; })
            // Once only the actual binding are left, let the emitter listen to observable change:attribute event.
            // TODO: Reduce the number of listeners attached as many bindings may listen
            // to the same observable attribute.
            .map(function (templateBinding) { return templateBinding.activateAttributeListener(schema, updater, data); });
        if (revertData) {
     ...
     */
    Template.prototype._revertTemplateFromNode = function (node, revertData) {
        for (var _i = 0, _a = revertData.bindings; _i < _a.length; _i++) {
            var binding = _a[_i];
            ...
            //		]
            //
            for (var _b = 0, binding_1 = binding; _b < binding_1.length; _b++) {
                var revertBinding = binding_1[_b];
                revertBinding();
            }
        }
        if (revertData.text) {
...
var TemplateBinding = /** @class */ (function () {
     ...
     */
    TemplateBinding.prototype.getValue = function (node) {
     ...
     */
    TemplateBinding.prototype.activateAttributeListener = function (schema, updater, data) {
        var _this = this;
        var callback = function () { return syncValueSchemaValue(schema, updater, data); };
        this.emitter.listenTo(this.observable, 'change:' + this.attribute, callback);
        // Allows revert of the listener.
        return function () {
            _this.emitter.stopListening(_this.observable, 'change:' + _this.attribute, callback);
        };
    };
 ...
 * @protected
 */
var TemplateToBinding = /** @class */ (function (_super) {
    __extends(TemplateToBinding, _super);
     ...
     * @returns {Function} A function to sever the listener binding.
     */
    TemplateToBinding.prototype.activateDomEventListener = function (domEvtName, domSelector, data) {
        var _this = this;
        var callback = function (evt, domEvt) {
            if (!domSelector || domEvt.target.matches(domSelector)) {
                if (typeof _this.eventNameOrFunction == 'function') {
                    _this.eventNameOrFunction(domEvt);
                }
                else {
                    _this.observable.fire(_this.eventNameOrFunction, domEvt);
                }
            }
        };
        ...
        // Allows revert of the listener.
        return function () {
            _this.emitter.stopListening(data.node, domEvtName, callback);
        };
    };
 ...
 * @protected
 */
var TemplateIfBinding = /** @class */ (function (_super) {
    __extends(TemplateIfBinding, _super);
     ...
     * @inheritDoc
     */
    TemplateIfBinding.prototype.getValue = function (node) {
        var value = _super.prototype.getValue.call(this, node);
...
// @param {Node} node DOM Node updated when {@link module:utils/observablemixin~ObservableMixin} changes.
function syncValueSchemaValue(schema, updater, _a) {
    var node = _a.node;
    ...
    if (!def.text) {
        ...
        if (def.children) {
            if (isViewCollection(def.children)) {
                ...
                for (var _i = 0, _a = def.children; _i < _a.length; _i++) {
                    var child = _a[_i];
...
function extendTemplate(template, def) {
    ...
    if (def.text) {
        (_a = template.text).push.apply(_a, def.text);
    }
    if (def.children && def.children.length) {
        ...
        var childIndex = 0;
        for (var _i = 0, _b = def.children; _i < _b.length; _i++) {
            var childDef = _b[_i];
...
var View = /** @class */ (function () {
    ...
    Object.defineProperty(View.prototype, "bindTemplate", {
        /**
     ...
     */
    View.prototype.createCollection = function (views) {
     ...
     */
    View.prototype.registerChild = function (children) {
     ...
     */
    View.prototype.deregisterChild = function (children) {
        if (!isIterable(children)) {
            children = [children];
        }
     ...
     */
    View.prototype.setTemplate = function (definition) {
     ...
     */
    View.prototype.extendTemplate = function (definition) {
    ...
    View.prototype.destroy = function () {
        this.stopListening();
        this._viewCollections.map(function (c) { return c.destroy(); });
...
var IconView = /** @class */ (function (_super) {
    ...
    IconView.prototype.render = function () {
        ...
        this.on('change:content', function () {
            _this._updateXMLContent();
            _this._colorFillPaths();
        });
     ...
     * @private
     */
    IconView.prototype._updateXMLContent = function () {
        if (this.content) {
     ...
     * @private
     */
    IconView.prototype._colorFillPaths = function () {
        var _this = this;
        if (this.fillColor) {
            this.element.querySelectorAll('.ck-icon__fill').forEach(function (path) {
                path.style.fill = _this.fillColor;
            });
        }
    };
    return IconView;
...
var Rect = /** @class */ (function () {
    ...
    function Rect(source) {
        ...
        if (isElement(source) || isSourceRange) {
            ...
            var innerWidth = source.innerWidth, innerHeight = source.innerHeight;
     ...
     */
    Rect.prototype.getIntersection = function (anotherRect) {
        var rect = {
     ...
     */
    Rect.prototype.getIntersectionArea = function (anotherRect) {
     ...
     */
    Rect.prototype.getVisible = function () {
    ...
    Rect.prototype.isEqual = function (anotherRect) {
        for (var _i = 0, rectProperties_1 = rectProperties; _i < rectProperties_1.length; _i++) {
            var prop = rectProperties_1[_i];
     ...
     */
    Rect.prototype.contains = function (anotherRect) {
     ...
     */
    Rect.prototype.excludeScrollbarsAndBorders = function () {
        var source = this._source;
     ...
     */
    Rect.getDomRangeRects = function (range) {
        var rects = [];
        // Safari does not iterate over ClientRectList using for...of loop.
        var clientRects = Array.from(range.getClientRects());
        if (clientRects.length) {
            for (var _i = 0, clientRects_1 = clientRects; _i < clientRects_1.length; _i++) {
                var rect = clientRects_1[_i];
        ...
        // https://github.com/ckeditor/ckeditor5-ui/issues/317
            ...
            var rect = new Rect(startContainer.getBoundingClientRect());
     ...
     */
    Rect.getBoundingRect = function (rects) {
...
function copyRectProperties(rect, source) {
    for (var _i = 0, rectProperties_2 = rectProperties; _i < rectProperties_2.length; _i++) {
        var p = rectProperties_2[_i];
        rect[p] = source[p];
    }
}
 ...
 */
function getOptimalPosition(_a) {
    var _b, _c;
    var element = _a.element, target = _a.target, positions = _a.positions, limiter = _a.limiter, fitInViewport = _a.fitInViewport;
    ...
    if (!limiter && !fitInViewport) {
        _b = getPositionNameAndRect(positions[0], targetRect, elementRect), bestPositionName = _b[0], bestPositionRect = _b[1];
    }
    else {
        var limiterRect = limiter && new Rect(limiter).getVisible();
        var viewportRect = fitInViewport && new Rect(global$1.window);
        var bestPosition = getBestPositionNameAndRect(positions, { targetRect: targetRect, elementRect: elementRect, limiterRect: limiterRect, viewportRect: viewportRect });
        // If there's no best position found, i.e. when all intersections have no area because
        // rects have no width or height, then just use the first available position.
        _c = bestPosition || getPositionNameAndRect(positions[0], targetRect, elementRect), bestPositionName = _c[0], bestPositionRect = _c[1];
    }
...
function getPositionNameAndRect(position, targetRect, elementRect) {
    ...
    var left = positionData.left, top = positionData.top, name = positionData.name;
...
function getBestPositionNameAndRect(positions, options) {
    var elementRect = options.elementRect, viewportRect = options.viewportRect;
    ...
    var processedPositions = processPositionsToAreas(positions, options);
    // First let's check all positions that fully fit in the viewport.
    if (viewportRect) {
        var processedPositionsInViewport = processedPositions.filter(function (_a) {
            var viewportIntersectArea = _a.viewportIntersectArea;
...
function processPositionsToAreas(positions, _a) {
    var targetRect = _a.targetRect, elementRect = _a.elementRect, limiterRect = _a.limiterRect, viewportRect = _a.viewportRect;
    ...
    for (var _i = 0, positions_1 = positions; _i < positions_1.length; _i++) {
        ...
        var positionName = positionData[0], positionRect = positionData[1];
...
function getBestOfProcessedPositions(processedPositions, elementRectArea) {
    ...
    var bestPositionRect;
    var bestPositionName;
    for (var _i = 0, processedPositions_1 = processedPositions; _i < processedPositions_1.length; _i++) {
        var _a = processedPositions_1[_i], positionName = _a.positionName, positionRect = _a.positionRect, limiterIntersectArea = _a.limiterIntersectArea, viewportIntersectArea = _a.viewportIntersectArea;
...
function shiftRectCoordinatesDueToPositionedAncestor(_a, positionedElementAncestor) {
...
function getAbsoluteRectCoordinates(_a) {
    var left = _a.left, top = _a.top;
    var _b = global$1.window, scrollX = _b.scrollX, scrollY = _b.scrollY;
    return {
        left: left + scrollX,
        top: top + scrollY
    };
 ...
 */
var toPx = toUnit('px');
var defaultLimiterElement = global$1.document.body;
/**
 ...
 * @extends module:ui/view~View
 */
var BalloonPanelView = /** @class */ (function (_super) {
    __extends(BalloonPanelView, _super);
    /**
     * @inheritDoc
     */
        ...
        _this.setTemplate({
            ...
            attributes: {
                class: [
                    'ck',
                    'ck-balloon-panel',
                    bind.to('position', function (value) { return "ck-balloon-panel_" + value; }),
     ...
     * See {@link #isVisible}.
     */
    BalloonPanelView.prototype.show = function () {
        this.isVisible = true;
    };
    /**
     * Hides the panel.
     ...
     * See {@link #isVisible}.
     */
    BalloonPanelView.prototype.hide = function () {
     ...
     * {@link module:ui/panel/balloon/balloonpanelview~BalloonPanelView.defaultPositions}.
     */
    BalloonPanelView.prototype.attachTo = function (options) {
        this.show();
        ...
        var optimalPosition = BalloonPanelView._getOptimalPosition(positionOptions);
     ...
     * {@link module:ui/panel/balloon/balloonpanelview~BalloonPanelView.defaultPositions}.
     */
    BalloonPanelView.prototype.pin = function (options) {
        var _this = this;
        this.unpin();
        this._pinWhenIsVisibleCallback = function () {
            if (_this.isVisible) {
                _this._startPinning(options);
            }
            else {
                _this._stopPinning();
            }
     ...
     */
    BalloonPanelView.prototype.unpin = function () {
     ...
     */
    BalloonPanelView.prototype._startPinning = function (options) {
        var _this = this;
        this.attachTo(options);
        var targetElement = getDomElement(options.target);
        var limiterElement = options.limiter ? getDomElement(options.limiter) : defaultLimiterElement;
        // Then we need to listen on scroll event of eny element in the document.
        this.listenTo(global$1.document, 'scroll', function (evt, domEvt) {
            ...
            var isLimiterWithinScrollTarget = limiterElement && scrollTarget.contains(limiterElement);
            // The positioning target and/or limiter can be a Rect, object etc..
            // There's no way to optimize the listener then.
            if (isWithinScrollTarget || isLimiterWithinScrollTarget || !targetElement || !limiterElement) {
                _this.attachTo(options);
            }
        }, { useCapture: true });
        // We need to listen on window resize event and update position.
        this.listenTo(global$1.window, 'resize', function () {
            _this.attachTo(options);
        });
    };
    /**
     ...
     * @private
     */
    BalloonPanelView.prototype._stopPinning = function () {
...
BalloonPanelView.defaultPositions = {
    // ------- North west
    northWestArrowSouthWest: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_sw'
    }); },
    northWestArrowSouthMiddleWest: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left - (balloonRect.width * .25) - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_smw'
    }); },
    northWestArrowSouth: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left - balloonRect.width / 2,
        name: 'arrow_s'
    }); },
    northWestArrowSouthMiddleEast: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left - (balloonRect.width * .75) + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_sme'
    }); },
    northWestArrowSouthEast: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left - balloonRect.width + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_se'
    }); },
    // ------- North
    northArrowSouthWest: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left + targetRect.width / 2 - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_sw'
    }); },
    northArrowSouthMiddleWest: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left + targetRect.width / 2 - (balloonRect.width * .25) - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_smw'
    }); },
    northArrowSouth: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left + targetRect.width / 2 - balloonRect.width / 2,
        name: 'arrow_s'
    }); },
    northArrowSouthMiddleEast: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left + targetRect.width / 2 - (balloonRect.width * .75) + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_sme'
    }); },
    northArrowSouthEast: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.left + targetRect.width / 2 - balloonRect.width + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_se'
    }); },
    // ------- North east
    northEastArrowSouthWest: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.right - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_sw'
    }); },
    northEastArrowSouthMiddleWest: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.right - (balloonRect.width * .25) - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_smw'
    }); },
    northEastArrowSouth: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.right - balloonRect.width / 2,
        name: 'arrow_s'
    }); },
    northEastArrowSouthMiddleEast: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.right - (balloonRect.width * .75) + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_sme'
    }); },
    northEastArrowSouthEast: function (targetRect, balloonRect) { return ({
        top: getNorthTop(targetRect, balloonRect),
        left: targetRect.right - balloonRect.width + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_se'
    }); },
    // ------- South west
    southWestArrowNorthWest: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nw'
    }); },
    southWestArrowNorthMiddleWest: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left - (balloonRect.width * .25) - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nmw'
    }); },
    southWestArrowNorth: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left - balloonRect.width / 2,
        name: 'arrow_n'
    }); },
    southWestArrowNorthMiddleEast: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left - (balloonRect.width * .75) + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nme'
    }); },
    southWestArrowNorthEast: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left - balloonRect.width + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_ne'
    }); },
    // ------- South
    southArrowNorthWest: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left + targetRect.width / 2 - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nw'
    }); },
    southArrowNorthMiddleWest: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left + targetRect.width / 2 - (balloonRect.width * 0.25) - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nmw'
    }); },
    southArrowNorth: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left + targetRect.width / 2 - balloonRect.width / 2,
        name: 'arrow_n'
    }); },
    southArrowNorthMiddleEast: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left + targetRect.width / 2 - (balloonRect.width * 0.75) + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nme'
    }); },
    southArrowNorthEast: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.left + targetRect.width / 2 - balloonRect.width + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_ne'
    }); },
    // ------- South east
    southEastArrowNorthWest: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.right - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nw'
    }); },
    southEastArrowNorthMiddleWest: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.right - (balloonRect.width * .25) - BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nmw'
    }); },
    southEastArrowNorth: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.right - balloonRect.width / 2,
        name: 'arrow_n'
    }); },
    southEastArrowNorthMiddleEast: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.right - (balloonRect.width * .75) + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_nme'
    }); },
    southEastArrowNorthEast: function (targetRect, balloonRect) { return ({
        top: getSouthTop(targetRect),
        left: targetRect.right - balloonRect.width + BalloonPanelView.arrowHorizontalOffset,
        name: 'arrow_ne'
    }); }
...
function toWidget(element, writer, options) {
    ...
    if (!element.is('containerElement')) {
         ...
         */
        throw new CKEditorError('widget-to-widget-wrong-element-type', null, { element: element });
    }
    ...
    setHighlightHandling(element, writer, function (element, descriptor, writer) { return writer.addClass(toArray(descriptor.classes), element); }, function (element, descriptor, writer) { return writer.removeClass(toArray(descriptor.classes), element); });
    return element;
}
/**
...
function setHighlightHandling(element, writer, add, remove) {
    ...
    writer.setCustomProperty('addHighlight', function (element, descriptor, writer) { return stack.add(descriptor, writer); }, element);
    writer.setCustomProperty('removeHighlight', function (element, id, writer) { return stack.remove(id, writer); }, element);
}
/**
...
function findOptimalInsertionPosition(selection, model) {
    ...
    if (selectedElement) {
        var typeAroundFakeCaretPosition = getTypeAroundFakeCaretPosition(selection);
    ...
    if (firstBlock) {
        ...
        var positionAfter = model.createPositionAfter(firstBlock);
...
function addSelectionHandle(widgetElement, writer) {
    var selectionHandle = writer.createUIElement('div', { class: 'ck ck-widget__selection-handle' }, function (domDocument) {
 ...
 */
function insertImage(model, attributes, insertPosition) {
    if (attributes === void 0) { attributes = {}; }
    if (insertPosition === void 0) { insertPosition = null; }
    model.change(function (writer) {
        var imageElement = writer.createElement('image', attributes);
        var insertAtSelection = insertPosition || findOptimalInsertionPosition(model.document.selection, model);
...
function getViewImgFromWidget(figureView) {
    var figureChildren = [];
    for (var _i = 0, _a = figureView.getChildren(); _i < _a.length; _i++) {
        var figureChild = _a[_i];
        figureChildren.push(figureChild);
        if (figureChild.is('element')) {
            figureChildren.push.apply(figureChildren, figureChild.getChildren());
        }
    }
    return figureChildren.find(function (viewChild) { return viewChild.is('element', 'img'); });
}
...
function isInOtherImage(selection) {
    return __spreadArrays(selection.focus.getAncestors()).every(function (ancestor) { return !ancestor.is('element', 'image'); });
}
...
var Command = /** @class */ (function () {
     ...
     */
    Command.prototype.forceDisabled = function (id) {
        this._disableStack.add(id);
        if (this._disableStack.size == 1) {
     ...
     * @param {String} id Unique identifier, equal to the one passed in {@link #forceDisabled} call.
     */
    Command.prototype.clearForceDisabled = function (id) {
        this._disableStack.delete(id);
        if (this._disableStack.size == 0) {
 ...
 */
var DomEventData = /** @class */ (function () {
    /**
    ...
    Object.defineProperty(DomEventData.prototype, "target", {
        /**
     ...
     */
    DomEventData.prototype.preventDefault = function () {
        this.domEvent.preventDefault();
    };
    /**
     * Stops native event propagation.
     */
    DomEventData.prototype.stopPropagation = function () {
 ...
 * @extends module:engine/view/observer/observer~Observer
 */
var DomEventObserver = /** @class */ (function (_super) {
    __extends(DomEventObserver, _super);
    /**
     ...
     * @inheritDoc
     */
    DomEventObserver.prototype.observe = function (domElement) {
        var _this = this;
        var types = typeof this.domEventType == 'string' ? [this.domEventType] : this.domEventType;
        types.forEach(function (type) {
            _this.listenTo(domElement, type, function (eventInfo, domEvent) {
                if (_this.isEnabled && !_this.checkShouldIgnoreEventFromTarget(domEvent.target)) {
                    _this.onDomEvent(domEvent);
                }
            }, { useCapture: _this.useCapture });
        });
    };
    /**
     ...
     */
    DomEventObserver.prototype.fire = function (eventType, domEvent, additionalData) {
        if (this.isEnabled) {
...
var MouseObserver = /** @class */ (function (_super) {
    ...
    MouseObserver.prototype.onDomEvent = function (domEvent) {
...
function getCode(key) {
    ...
    if (typeof key == 'string') {
        ...
        if (!keyCode) {
             ...
             * @param {String} key
             */
            throw new CKEditorError('keyboard-unknown-key', null, { key: key });
        }
    }
    else {
        keyCode = key.keyCode +
...
function parseKeystroke(keystroke) {
    ...
    return keystroke
        .map(function (key) { return (typeof key == 'string') ? getCode(key) : key; })
        .reduce(function (key, sum) { return sum + key; }, 0);
}
/**
...
function getEnvKeystrokeText(keystroke) {
    ...
    return splitKeystrokeText(keystroke)
        ...
        .map(function (key) { return modifiersToMacGlyphs[key.toLowerCase()] || key; })
        ...
        _this.setTemplate({
            ...
            attributes: {
                class: [
                    'ck',
                    'ck-tooltip',
                    bind.to('position', function (position) { return 'ck-tooltip_' + position; }),
                    bind.if('text', 'ck-hidden', function (value) { return !value.trim(); })
                ]
            },
            children: [
                {
...
var ButtonView = /** @class */ (function (_super) {
        ...
        _this.setTemplate({
            ...
            attributes: {
                class: [
                    ...
                    bind.if('isVisible', 'ck-hidden', function (value) { return !value; }),
                    bind.to('isOn', function (value) { return value ? 'ck-on' : 'ck-off'; }),
                    bind.if('withText', 'ck-button_with-text'),
                    bind.if('withKeystroke', 'ck-button_with-keystroke')
                ],
                type: bind.to('type', function (value) { return value ? value : 'button'; }),
                tabindex: bind.to('tabindex'),
                'aria-labelledby': "ck-editor__aria-label_" + ariaLabelUid,
                'aria-disabled': bind.if('isEnabled', true, function (value) { return !value; }),
                'aria-pressed': bind.to('isOn', function (value) { return _this.isToggleable ? String(value) : false; })
            },
     ...
     */
    ButtonView.prototype.focus = function () {
        this.element.focus();
    };
    /**
     ...
     */
    ButtonView.prototype._createTooltipView = function () {
     ...
     */
    ButtonView.prototype._createLabelView = function (ariaLabelUid) {
     ...
     * @returns {module:ui/view~View}
     */
    ButtonView.prototype._createKeystrokeView = function () {
        ...
        keystrokeView.setTemplate({
            ...
            children: [
                {
                    text: this.bindTemplate.to('keystroke', function (text) { return getEnvKeystrokeText(text); })
                }
            ]
        });
     ...
     * @returns {String}
     */
    ButtonView.prototype._getTooltipString = function (tooltip, label, keystroke) {
        if (tooltip) {
 ...
 */
function clickOutsideHandler(_a) {
    var emitter = _a.emitter, activator = _a.activator, callback = _a.callback, contextElements = _a.contextElements;
    emitter.listenTo(document, 'mousedown', function (evt, domEvt) {
        ...
        for (var _i = 0, contextElements_1 = contextElements; _i < contextElements_1.length; _i++) {
            var contextElement = contextElements_1[_i];
...
var FocusTracker = /** @class */ (function () {
     ...
     */
    FocusTracker.prototype.add = function (element) {
        var _this = this;
        ...
        this.listenTo(element, 'focus', function () { return _this._focus(element); }, { useCapture: true });
        this.listenTo(element, 'blur', function () { return _this._blur(); }, { useCapture: true });
     ...
     * @param {HTMLElement} element
     */
    FocusTracker.prototype.remove = function (element) {
     ...
     */
    FocusTracker.prototype._focus = function (element) {
     ...
     * @fires blur
     */
    FocusTracker.prototype._blur = function () {
        var _this = this;
        clearTimeout(this._nextEventLoopTimeout);
 ...
 *
 */
var KeystrokeHandler = /** @class */ (function () {
    /**
     ...
     * @param {module:utils/emittermixin~Emitter} emitter
     */
    KeystrokeHandler.prototype.listenTo = function (emitter) {
        var _this = this;
     ...
     */
    KeystrokeHandler.prototype.set = function (keystroke, callback, options) {
        if (options === void 0) { options = {}; }
     ...
     */
    KeystrokeHandler.prototype.press = function (keyEvtData) {
        return !!this._listener.fire('_keydown:' + getCode(keyEvtData), keyEvtData);
    };
    /**
     * Destroys the keystroke handler.
     */
    KeystrokeHandler.prototype.destroy = function () {
...
var DropdownView = /** @class */ (function (_super) {
    ...
    DropdownView.prototype.render = function () {
        ...
        this.on('change:isOpen', function () {
            ...
            if (_this.panelPosition === 'auto') {
                _this.panelView.position = DropdownView._getOptimalPosition({
                    element: _this.panelView.element,
                    target: _this.buttonView.element,
                    fitInViewport: true,
                    positions: _this._panelPositions
                }).name;
            }
            else {
                _this.panelView.position = _this.panelPosition;
            }
        });
        // Listen for keystrokes coming from within #element.
        this.keystrokes.listenTo(this.element);
        var closeDropdown = function (data, cancel) {
            if (_this.isOpen) {
                _this.buttonView.focus();
                _this.isOpen = false;
                cancel();
            }
        };
        ...
        this.keystrokes.set('arrowdown', function (data, cancel) {
            ...
            if (_this.buttonView.isEnabled && !_this.isOpen) {
                _this.isOpen = true;
                cancel();
            }
        });
     ...
     */
    DropdownView.prototype.focus = function () {
        this.buttonView.focus();
    };
    Object.defineProperty(DropdownView.prototype, "_panelPositions", {
        /**
         ...
         */
        get: function () {
            var _a = DropdownView.defaultPanelPositions, south = _a.south, north = _a.north, southEast = _a.southEast, southWest = _a.southWest, northEast = _a.northEast, northWest = _a.northWest, southMiddleEast = _a.southMiddleEast, southMiddleWest = _a.southMiddleWest, northMiddleEast = _a.northMiddleEast, northMiddleWest = _a.northMiddleWest;
...
DropdownView.defaultPanelPositions = {
    south: function (buttonRect, panelRect) {
        return {
    ...
    southWest: function (buttonRect, panelRect) {
        return {
            top: buttonRect.bottom,
    ...
    southMiddleEast: function (buttonRect, panelRect) {
        return {
            top: buttonRect.bottom,
    ...
    southMiddleWest: function (buttonRect, panelRect) {
        return {
            top: buttonRect.bottom,
    ...
    north: function (buttonRect, panelRect) {
        return {
    ...
    northEast: function (buttonRect, panelRect) {
        return {
            top: buttonRect.top - panelRect.height,
            left: buttonRect.left,
            name: 'ne'
    ...
    northWest: function (buttonRect, panelRect) {
        return {
            top: buttonRect.top - panelRect.height,
            left: buttonRect.left - panelRect.width + buttonRect.width,
            name: 'nw'
    ...
    northMiddleEast: function (buttonRect, panelRect) {
        return {
            top: buttonRect.top - panelRect.height,
            left: buttonRect.left - (panelRect.width - buttonRect.width) / 4,
            name: 'nme'
    ...
    northMiddleWest: function (buttonRect, panelRect) {
        return {
            top: buttonRect.top - panelRect.height,
            left: buttonRect.left - (panelRect.width - buttonRect.width) * 3 / 4,
            name: 'nmw'
 ...
 * Check out the {@glink framework/guides/deep-dive/ui/focus-tracking "Deep dive into focus tracking" guide} to learn more.
 */
var FocusCycler = /** @class */ (function () {
    /**
    ...
    Object.defineProperty(FocusCycler.prototype, "first", {
        /**
    ...
    Object.defineProperty(FocusCycler.prototype, "last", {
        /**
    ...
    Object.defineProperty(FocusCycler.prototype, "next", {
        /**
    ...
    Object.defineProperty(FocusCycler.prototype, "previous", {
        /**
    ...
    Object.defineProperty(FocusCycler.prototype, "current", {
        /**
        ...
        get: function () {
            ...
            this.focusables.find(function (view, viewIndex) {
                var focused = view.element === _this.focusTracker.focusedElement;
                if (focused) {
                    index = viewIndex;
                }
                return focused;
     ...
     */
    FocusCycler.prototype.focusFirst = function () {
        this._focus(this.first);
    };
    /**
     * Focuses the {@link #last} item in {@link #focusables}.
     */
    FocusCycler.prototype.focusLast = function () {
        this._focus(this.last);
    };
    /**
     * Focuses the {@link #next} item in {@link #focusables}.
     */
    FocusCycler.prototype.focusNext = function () {
        this._focus(this.next);
    };
    /**
     * Focuses the {@link #previous} item in {@link #focusables}.
     */
    FocusCycler.prototype.focusPrevious = function () {
     ...
     */
    FocusCycler.prototype._focus = function (view) {
        if (view) {
            view.focus();
        }
    };
     ...
     */
    FocusCycler.prototype._getFocusableItem = function (step) {
        // Cache for speed.
 ...
 */
var ResizeObserverPolyfill = /** @class */ (function () {
    /**
     ...
     * @param {HTMLElement} element
     */
    ResizeObserverPolyfill.prototype.observe = function (element) {
        this._elements.add(element);
     ...
     * @param {HTMLElement} element
     */
    ResizeObserverPolyfill.prototype.unobserve = function (element) {
        this._elements.delete(element);
     ...
     * @protected
     */
    ResizeObserverPolyfill.prototype._startPeriodicCheck = function () {
        var _this = this;
     ...
     * @protected
     */
    ResizeObserverPolyfill.prototype._stopPeriodicCheck = function () {
     ...
     * @protected
     */
    ResizeObserverPolyfill.prototype._checkElementRectsAndExecuteCallback = function () {
        var entries = [];
     ...
     * @returns {Boolean}
     */
    ResizeObserverPolyfill.prototype._hasRectChanged = function (element) {
        if (!element.ownerDocument.body.contains(element)) {
            return false;
        }
        var currentRect = new Rect(element);
        var previousRect = this._previousRects.get(element);
