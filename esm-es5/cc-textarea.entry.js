...
var CcTextarea = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        ...
        return (h(Host, { class: {
            ...
            }, maxLength: this.maxLength, name: this.name, value: this.value, onInput: function (e) { return _this.changeTextHandler(e.target.value); } })), (!!this.iconName && !this.rich) && (h("cc-icon", { class: {
                textarea__icon: true,
