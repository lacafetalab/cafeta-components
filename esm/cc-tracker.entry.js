    ...
    render() {
        ...
        return (h(Host, { class: "tracker", "data-testid": "cc-tracker" }, h("ul", { class: { tracker__list: true } }, this.showProgress && h("div", { class: "tracker__progress-base" }), this.showProgress && (h("div", { class: "tracker__progress", style: { width: `${this.progress}%` } }, " ")), (_a = this.trackersList) === null || _a === void 0 ? void 0 :
            _a.map((trackerItem, index) => {
                return (h("li", { class: { tracker__item: true }, onClick: () => this.handleClickTrack(trackerItem, index) }, h("div", { class: {
                    ...
                    } }, trackerItem.iconName && (h("cc-icon", { name: trackerItem.iconName })), !trackerItem.iconName && h("span", null, trackerItem.order)), !this.withoutLabel && (h("p", { class: {
                        tracker__label: true,
