...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-5afc52e3.js', document.baseURI).href));
