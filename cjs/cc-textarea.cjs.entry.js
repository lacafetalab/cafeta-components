...
const CcTextarea = class {
    constructor(hostRef) {
        ...
        this.totalCharacters = index.createEvent(this, "totalCharacters", 7);
    ...
    async enableRichTextEditor() {
        ...
        if (!this.rich)
            return null;
        const { default: ClassicEditor } = await Promise.resolve().then(function () { return require('./ckeditor-90583e38.js'); }).then(function (n) { return n.ckeditor; });
        const optionsEditor = {
            toolbar,
    ...
    render() {
        return (index.h(index.Host, { class: {
            ...
            }, maxLength: !this.maxLength ? undefined : this.maxLength, name: this.name, value: this.value, onInput: e => this.changeTextHandler(e.target.value) })), !!this.iconName && !this.rich && (index.h("cc-icon", { class: {
                textarea__icon: true,
                "textarea__icon--primary": this.color === "primary",
                "textarea__icon--secondary": this.color === "secondary"
            }, name: this.iconName })), index.h("div", { class: "textarea__wrapper-helper" }, index.h("div", null, this.helperText && this.error && !this.success && !this.disabled && (index.h("span", { class: "textarea__helperText", onClick: this.focusEditor }, this.helperText)), this.lengthCharacter > this.maxLength && this.counter && (index.h("span", { class: "textarea__helperText", onClick: this.focusEditor }, "Has excedido el n\u00FAmero de caracteres.")), this.isRequired && !this.lengthCharacter && this.isModified && (index.h("div", { class: "textarea__helperText-required" }, index.h("cc-icon", { size: 16, name: "alert-triangle" }), index.h("span", { class: "textarea__helperText", onClick: this.focusEditor }, "Es necesario completar esta informaci\u00F3n.")))), index.h("div", null, this.counter && (index.h("span", { class: "textarea__counter" }, index.h("span", null, !!this.maxLength && this.lengthCharacter > this.maxLength
            ? "-"
            : "", this.lengthCharacter), index.h("span", null, "/"), index.h("span", null, !!this.maxLength ? this.maxLength : "maxLength is missing")))))));
    }
