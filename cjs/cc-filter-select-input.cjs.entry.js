...
const CcFilterSelectInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "data-testid": "cc-filter-file-input", class: "filter-file-input" }, this.label && (index.h("span", { class: "filter-file-input__label" }, this.label)), index.h("cc-wrapper-field", Object.assign({ ref: (el) => (this.singleFileInput = el), class: {
                "filter-file-input__wrapper": true,
                "filter-file-input--is-collapse": this.isOpenDropdown,
            } }, attrs), index.h("div", { class: "filter-file-input__field", onClick: this.validateDisabled }, index.h("div", { class: {
                "filter-file-input__dot-wrapper": true,
                "filter-file-input__dot-wrapper--is-hidden": !this.knowIfThereIsASelected(),
            } }, index.h("ul", { class: "filter-file-input__dot-list" }, this.selectedChoices
            .map((selectedChoice) => this._choices.find((choice) => choice.value === selectedChoice))
            .map((choice) => (index.h("li", { class: "filter-file-input__dot-item" }, index.h("div", { class: "filter-file-input__dot-text" }, choice.label, index.h("div", { onClick: () => choice.disableRemove
                ? null
                : this.handleRemoveItemSelected(choice.value), class: "filter-file-input__dot-delete" }, index.h("cc-icon", { size: 12, name: "x" })))))))), index.h("p", { class: {
                "filter-file-input__placeholder": true,
                "filter-file-input__placeholder--is-hidden": this.validateShowPlaceholder(),
            } }, this.placeholder), index.h("cc-input", { style: {
            ...
            } }, this.filteredChoices().length === 0 && (index.h("li", { class: {
                "filter-file-input__placeholder": true,
            ...
            .map((c) => {
            return (index.h("li", { onClick: () => c.disabled || c.disableRemove
                    ? null
                ...
                } }, this.type === "checkbox" && (index.h("cc-checkfield", { class: "filter-file-input__option-checkbox", type: "checkbox", shape: "square", color: this.color, checked: c.selected })
            // <input
            //
            //   type="checkbox"
            //   name=""
...
exports.cc_filter_select_input = CcFilterSelectInput;
