...
const CcInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: {
            ...
            }, "data-testid": "cc-input" }, this.label && (index.h("label", { class: "input__label", onClick: this.focusInput }, this.label)), index.h("div", { class: "input__wrapper" }, index.h("input", { class: {
                input__field: true,
...
const CcWrapperField = class {
    ...
    render() {
        return (index.h(index.Host, { class: {
            ...
            } }, index.h("slot", null), index.h("div", { class: "wrapper-field__wrapper-icon" }, this.loader ? (index.h("cc-loader", null)) : (index.h("cc-icon", { class: {
                "wrapper-field__icon": true,
                "wrapper-field__icon--inverted": this.isActive && this.IconRotate
            }, name: this.iconName }))), this.helperText && this.error && !this.disabled && (index.h("span", { class: "wrapper-field__helperText" }, this.helperText))));
    }
};
CcWrapperField.style = ccWrapperFieldCss;

exports.cc_input = CcInput;
exports.cc_wrapper_field = CcWrapperField;
