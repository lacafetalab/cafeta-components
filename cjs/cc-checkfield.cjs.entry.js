...
const CcCheckfield = class {
    ...
    render() {
        return (index.h(index.Host, { "data-testid": "cc-checkfield", class: "CheckField" }, index.h("label", { class: "checkfield__wrapper" }, index.h("div", { class: {
            ...
            } }), this.shape === "square" && (index.h("cc-icon", { name: "check", class: "checkfield__check", size: this.size === "medium" ? 12 : 10 }))), this.label && index.h("span", { class: "checkfield__label" }, this.label))));
    }
};
