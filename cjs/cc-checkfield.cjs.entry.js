...
const CcCheckfield = class {
    ...
    render() {
        return (index.h(index.Host, { "data-testid": "cc-checkfield", class: "CheckField" }, index.h("label", { class: "checkfield__wrapper" }, index.h("div", { class: {
                "checkfield__wrapper-input": true,
                "checkfield__wrapper-input--medium": this.size === "medium"
            } }, index.h("input", { type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, ref: this.setInputRef, class: {
            ...
            } }), this.shape === "square" && (index.h("cc-icon", { name: "check", class: "checkfield__check", size: this.size === "medium" ? 12 : 10 }))), this.label && (index.h("span", { class: {
...
exports.cc_checkfield = CcCheckfield;
