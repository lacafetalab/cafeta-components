...
const CcNavbarWeb = class {
    ...
    render() {
        return (index.h(index.Host, null, this.datalist && this.datalist.length ? (index.h("div", { class: "navbar" }, index.h("div", null, index.h("cc-button", { class: "navbar__toggle", href: "#", target: "_blank" }, index.h("cc-icon", { name: "menu", class: "menu" })), index.h("ul", { class: { "navbar__list--vertical": true, navbar__list: true } }, this.datalist.map(list => (index.h("li", { class: {
                navbar__item: true,
                "navbar__item--selected": list.active
            } }, index.h("cc-button", { fill: "clear", href: list.url, target: "_blank" }, index.h("cc-icon", { size: 24, name: list.icon }), index.h("span", { class: "navbar__item-text" }, list.label))))))))) : (index.h("div", null, "Cargando..."))));
    }
