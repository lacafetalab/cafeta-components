...
const CcSwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { class: {
            ...
            } }, index.h("label", { class: { switch: true, "switch--sm": this.size === "sm" } }, index.h("input", { type: "checkbox", class: "switch__input", value: this.value, name: this.name, disabled: this.disabled, ref: this.setInputRef, checked: this.checked }), index.h("span", { class: {
                switch__slider: true,
...
exports.cc_switcher = CcSwitcher;
