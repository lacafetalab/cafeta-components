...
const CcButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: {
            ...
            }, "data-testid": "cc-button" }, index.h(BtnElem, Object.assign({ "data-testid": "cc-button__element", class: {
                button: true,
            ...
            } }, attrs), this.iconName && !this.loading && (index.h("cc-icon", { class: {
                button__icon: true
            }, name: this.iconName, size: this.size === "sm" ? 16 : 24 })), this.loading && (index.h("cc-loader", { class: {
                button__icon: true
            }, size: this.size === "sm" ? 16 : 24 })), index.h("span", { "data-testid": "cc-button__text", class: { button__text: !this.iconOnly, hidden: this.iconOnly } }, index.h("slot", null)))));
    }
};
